...
public class Client extends JFrame implements ActionListener {
    ...
    Client() {
        ...
        // setting the DP image of MS_DHONI
        ImageIcon I4 = new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/MS-DHoni-modified.png"));
...
//using timer function for changing typing status
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            SendTextToFile(out, "MS Dhoni");
            dout.writeUTF(out);
            // make that message to append in AREA PANEL A1
            JPanel p = formatLabel(out, (int) 0);
            // The panelp containd message sent along with its TIME
...
// FOR SPEECH BUBBLES
    ...
    public static JPanel formatLabel(String out, int i) {
        ...
        if (i == 1)// that means we are sending message
        {
            L.setBackground(new Color(52, 183, 241));
        } else // we are reading the message
        {
